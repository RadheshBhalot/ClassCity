...
<div id="aboutimg">
    <h3>Catering Equipment & Supplies</h3>
</div>
...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-3 mb-4">
            ...
            <ul class="list-group">
                @foreach([
                    'Bars', 'Casino', 'Catering Equipment & Supplies', 'Chairs', 'China', 'Entertainment',
                    'Flatware', 'Glassware', 'Heaters & Fans', 'Lighting', 'Outdoor Garden & Equipment',
                    'Punch Fountain & Bowls', 'Serving Pieces', 'Tables', 'Wedding Accessories & Equipment',
                    'Linens', 'Tents / Canopies', 'Sidewalls'
                ] as $category)
        ...
        <div class="col-md-9">
            <h4 class="mb-4">Catering Equipment & Suppliess</h4>
            <div class="row">
                @php
              $products = [
                    ['img' => '11eq.jfif', 'productName' => 'Beer Tap & Stand Combo', 'price' => 250],
                    ['img' => '12eq.jfif',             'productName' => 'Elegant Wooden Bar Setup', 'price' => 300],
                    ['img' => '13eq.jfif',          'productName' => 'Portable Cocktail Station', 'price' => 180],
                    ['img' => '14eq.jfif',             'productName' => 'Outdoor Mini Bar Table', 'price' => 200],
                    ['img' => '11eq.jfif',             'productName' => 'Premium Bar Counter', 'price' => 350],
                    ['img' => '16eq.jfif',             'productName' => 'LED Lighted Bar Unit', 'price' => 400],
                    ['img' => '17eq.jfif',             'productName' => 'Foldable Event Bar', 'price' => 270],
                ];
